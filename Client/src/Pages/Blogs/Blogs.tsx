  ...
  return (
    <div className="bg-[#faf8f6] min-h-screen pb-10">
      ...
      <div className="px-6 md:px-20 flex flex-col md:flex-row md:items-center md:justify-between gap-4 pb-6">
        <h1 className="text-2xl font-bold text-[#00FFFF]">Our Blog</h1>
          ...
          >
            ...
            <div className="p-6">
              <div className="text-xs text-gray-400 mb-1">
                {blog.author} &bull; {new Date(blog.date).toLocaleDateString()}
              </div>
              <h2 className="text-xl font-semibold mb-2 text-[#00FFFF] group-hover:text-primary-600 transition-colors">
                {blog.title}
              </h2>
        ...
        {rest.map((blog) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <h3 className="text-lg font-semibold mb-1 text-[#00FFFF] group-hover:text-primary-600 transition-colors">
                {blog.title}
              </h3>
              <p className="text-gray-600 text-sm line-clamp-2">
                {blog.excerpt}
      ...
      {filteredBlogs.length === 0 && (
        <div className="px-6 md:px-20 text-center text-gray-500 py-16 text-lg">
          No blogs found.
        </div>
      )}
    </div>
